...
void RCaster::raycast()
{
	...
	glm::mat4 view = glm::scale(m_pose * m_invK, glm::vec3(1, 1, 1));
	...
	//std::cout << view[3][0] << " " << view[3][1] << " " << view[3][2] << std::endl;
	...
	xWidth = GLHelper::divup(m_screenWidth, 32);
	yWidth = GLHelper::divup(m_screenHeight, 32);
