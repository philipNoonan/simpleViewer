...
layout(binding = 1, r16ui) uniform uimage1D edgeTable;
layout(binding = 2, r16ui) uniform uimage1D triTex;
layout(binding = 3, r16ui) uniform uimage1D numVertsTable;
...
float sampleVolume(uvec3 p, uvec3 gridSize)
{
    ...
    vec4 volData = imageLoad(volumeData, ivec3(p));
    //return 1.0f;
